...
class BookingSerializer(serializers.ModelSerializer):
    bus = BusSerializer()  # Nested BusSerializer to include detailed bus info

    class Meta:
        model = Booking
        fields = ['id', 'bus', 'name', 'email', 'phone', 'seats', 'booking_date', 'payment_method', 'pickup_location', 'pickup_time', 'expected_journey_duration', 'destination']
